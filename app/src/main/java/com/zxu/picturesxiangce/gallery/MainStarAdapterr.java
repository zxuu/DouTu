...
public class MainStarAdapterr extends PagerAdapter {
...
//    private TextView mTvDesc;
    ...
    private CustomViewPagerr mViewPager;
    private int mOriginSize ;
    private boolean hasInitTotal=false;
    private String tag;

    public MainStarAdapterr(List<String> data, Context context, CustomViewPagerr viewPager, int originSize) {
        mDatas = data;
        mContext = context;
